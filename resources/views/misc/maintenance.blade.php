...
<body>
    <div class="container">
        <div class="what-is-up">
            ...
            <h2>Our developers are working hard to update the system. Please wait while we do this. Sorry for the inconvenience.</h2>
        </div>
    </div>
</body>
</html>
