...
@php
    ...
    $profilePictureUrl = $consultant?->getFirstMediaUrl('consultant_pictures') ?: asset('site/images/default-dp.png');
@endphp
<div class="top-nav-container p-0 mt-1">
    ...
    <div class="container d-flex justify-content-between align-items-center">
        <ul class="nav nav-tabs" id="mainNav">
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('consultants.dashboard') ? 'active' : '' }}" 
                   href="{{ route('consultants.dashboard') }}">
                    <i class="bi bi-house-door"></i> &nbsp; Dashboard
                </a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->routeIs('consultants.registration.*') ? 'active' : '' }}" 
                   href="#" 
                ...
                <ul class="dropdown-menu shadow" aria-labelledby="registrationDropdown">
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('consultants.registration.create') }}">
                            <i class="bi bi-pencil-square"></i> &nbsp; Apply for Registration
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('consultants.registration.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('consultants.hr.create') ? 'active' : '' }}" 
                   href="{{ route('consultants.hr.create') }}">
                    <i class="bi-people"></i> &nbsp; Human Resource
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('consultants.machinery.create') ? 'active' : '' }}" 
                   href="{{ route('consultants.machinery.create') }}">
                    <i class="bi-gear"></i> &nbsp; Machinary
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('consultants.experience.create') ? 'active' : '' }}" 
                   href="{{ route('consultants.experience.create') }}">
