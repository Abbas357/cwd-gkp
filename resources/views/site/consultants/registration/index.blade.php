        ...
        <div class="card">
            <div class="card-header bg-light">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="mb-0">Consultant Registrations</h4>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('consultants.registration.create') }}" class="btn btn-primary">
                            New Registration
                        </a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form action="{{ route('consultants.registration.index') }}" method="GET" class="mb-4">
                    <div class="row g-2">
                        <div class="col-md-4">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('consultants.registration.index') }}" class="btn btn-light">Reset</a>
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse($registrations as $registration)
                                <tr>
                                    ...
                                    <td>
                                        <a class="cw-btn" href="{{ route('consultants.registration.show', $registration->uuid) }}">
                                            <i class="bi-eye"></i>
                                        </a>
                                        @if($registration->can_edit)
                                        <a class="cw-btn cw-btn-secondary" href="{{ route('consultants.registration.edit', $registration->uuid) }}">
                                            <i class="bi-pencil"></i>
                                        </a>
                                        @endif
                                    </td>
