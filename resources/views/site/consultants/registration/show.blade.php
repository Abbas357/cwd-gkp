<x-main-layout>
    ...
    <div class="container my-4">
        <div class="card" id="consultant-detail">
            <div class="card-header bg-light">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto no-print">
                        ...
                        <a href="{{ route('consultants.registration.index') }}" class="btn btn-light">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <table class="table table-borderless">
                                    <tr>
                                        <th width="40%">Name</th>
                                        <td>{{ $registration->consultant->name }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">Firm Name</th>
                                        <td>{{ $registration->consultant->firm_name }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">Email</th>
                                        <td>{{ $registration->consultant->email }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">Mobile Number</th>
                                        <td>{{ $registration->consultant->mobile_number }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">District</th>
                                        <td>{{ $registration->consultant->district }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">Address</th>
                                        <td>{{ $registration->consultant->address }}</td>
                                    </tr>
                                    <tr>
                                        <th width="40%">CNIC</th>
                                        <td>{{ $registration->consultant->cnic }}</td>
                                    </tr>
                                    <tr>
                                        <th>Status</th>
                                        <td>
