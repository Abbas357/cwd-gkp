        ...
        <div class="login-box">
            ...
            <div class="auth-form" id="loginForm">
                <div class="bg-dark text-white text-center py-4 rounded-top mb-4">
                    <h4 class="fw-bold mb-0">Firm Standardization Login</h4>
                    <span>(If you don't have account please <a class="switch-form-btn" href="{{ route('standardizations.register')}}">Register</a> here)</span>
                </div>

                <form class="row g-3" method="POST" action="{{ route('standardizations.login.post') }}">
                    @csrf
                    <div class="col-12">
