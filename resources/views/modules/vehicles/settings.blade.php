                    ...
                    <div class="card-body p-0">
                        <div class="nav flex-column nav-tabs" id="settings-tabs" role="tablist">
                            ...
                            <button class="nav-link settings-tab" id="vehicle_type-tab" data-bs-toggle="tab" data-bs-target="#vehicle_type" type="button" role="tab" aria-controls="vehicle_type" aria-selected="false">
                                <i class="bi bi-signpost me-2"></i> Vehicle Type
                            </button>
                            <button class="nav-link settings-tab" id="vehicle_functional_status-tab" data-bs-toggle="tab" data-bs-target="#vehicle_functional_status" type="button" role="tab" aria-controls="vehicle_functional_status" aria-selected="false">
                                <i class="bi bi-signpost me-2"></i> Vehicle Functional Status
                            </button>
                            <button class="nav-link settings-tab" id="vehicle_color-tab" data-bs-toggle="tab" data-bs-target="#vehicle_color" type="button" role="tab" aria-controls="vehicle_color" aria-selected="false">
                                <i class="bi bi-building me-2"></i> Vehicle Color
                            </button>
                            ...
                            <button class="nav-link settings-tab" id="vehicle_registration_status-tab" data-bs-toggle="tab" data-bs-target="#vehicle_registration_status" type="button" role="tab" aria-controls="vehicle_registration_status" aria-selected="false">
                                <i class="bi bi-list-check me-2"></i> Vehicle Registration Status
                            </button>
                            <button class="nav-link settings-tab" id="vehicle_brand-tab" data-bs-toggle="tab" data-bs-target="#vehicle_brand" type="button" role="tab" aria-controls="vehicle_brand" aria-selected="false">
                                <i class="bi bi-list-check me-2"></i> Vehicle Brand
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <form id="settingsForm" action="{{ route('admin.apps.vehicles.settings.update') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="category-container" data-category-key="vehicle_type">
                                        <p class="text-muted mb-3">Define the Vehicle types in the system.</p>
                        ...
                        <div class="tab-pane fade" id="vehicle_functional_status" role="tabpanel" aria-labelledby="vehicle_functional_status-tab">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Vehicle Functional Status</h5>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Vehicle Functional Status...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
                        ...
                        <div class="tab-pane fade" id="vehicle_color" role="tabpanel" aria-labelledby="vehicle_color-tab">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Vehicle Color</h5>
                                </div>
                                <div class="card-body">
                                    <div class="category-container" data-category-key="vehicle_color">
                                        <p class="text-muted mb-3">Define the Vehicle Color in the system.</p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Vehicle Color...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
                        ...
                        <!-- Fuel Type Category -->
                        <div class="tab-pane fade" id="fuel_type" role="tabpanel" aria-labelledby="fuel_type-tab">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Fuel Type</h5>
                                </div>
                                <div class="card-body">
                                    <div class="category-container" data-category-key="fuel_type">
                                        <p class="text-muted mb-3">Define the power source in the system.</p>
                                        
                                        <input type="hidden" name="categories[fuel_type][description]" value="Types of Fuel Type">
                                        <input type="hidden" name="categories[fuel_type][type]" value="category">
                                                    ...
                                                    <tbody>
                                                        @foreach(category('fuel_type', 'vehicle', []) as $index => $item)
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control" 
                                                                        name="categories[fuel_type][value][]" 
                                                                        value="{{ $item }}" required>
                                                                </td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-sm btn-danger remove-item">
                        ...
                        <!-- Vehicle Registration Status Category -->
                        <div class="tab-pane fade" id="vehicle_registration_status" role="tabpanel" aria-labelledby="vehicle_registration_status-tab">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Vehicle Registration Status</h5>
                                </div>
                                <div class="card-body">
                                    <div class="category-container" data-category-key="vehicle_registration_status">
                                        <p class="text-muted mb-3">Define the Vehicle Registration Statuss in the system.</p>
                                        
                                        <input type="hidden" name="categories[vehicle_registration_status][description]" value="Types of Vehicle Registration Status">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Vehicle Registration Status...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
                        ...
                        <div class="tab-pane fade" id="vehicle_brand" role="tabpanel" aria-labelledby="vehicle_brand-tab">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Vehicle Brands</h5>
                                </div>
                                <div class="card-body">
                                    <div class="category-container" data-category-key="vehicle_brand">
                                        <p class="text-muted mb-3">Define the Vehicle brands in the system.</p>
