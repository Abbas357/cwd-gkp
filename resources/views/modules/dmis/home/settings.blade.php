<x-dmis-layout title="Damage Tracking System Settings">
    @push('style')
        <style>
    ...
    @endpush
    <x-slot name="header">
        <li class="breadcrumb-item"><a href="{{ route('admin.apps.dmis.dashboard') }}">Damage Tracking System</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <form action="{{ route('admin.apps.dmis.settings.init') }}" method="POST" onsubmit="return confirm('This will reset all settings to default values. Continue?');">
                            @csrf
            ...
            <div class="col-md-9">
                <form id="settingsForm" action="{{ route('admin.apps.dmis.settings.update') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('activity') is-invalid @enderror" name="settings[activity][value]" placeholder="Activity" required>
                                            ...
                                            @foreach($activityTypes as $type)
                                                <option value="{{ $type }}" @selected(setting('activity', 'dmis') == $type)>
                                                    {{ $type }}
                                                </option>
                                            @endforeach
                                        </select>                                      
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('session') is-invalid @enderror" name="settings[session][value]" placeholder="Session" required>
                                            ...
                                            @foreach($years as $year)
                                                <option value="{{ $year }}" @selected(setting('session', 'dmis') == $year)>
                                                    {{ $year }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="mb-3">
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        @foreach(category('road_status', 'dmis', []) as $index => $item)
                                                            <tr>
                                                                <td>
                                        ...
                                        <div class="mb-3">
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        @foreach(category('infrastructure_type', 'dmis', []) as $index => $item)
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control" 
                                        ...
                                        <div class="mb-3">
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        @foreach(category('damage_status', 'dmis', []) as $index => $item)
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control" 
                                        ...
                                        <div class="mb-3">
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        @foreach(category('damage_nature', 'dmis', []) as $index => $item)
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control" 
