<div class="action-btns">
    @can('view', $row)
    <button class="view-logs-btn btn btn-sm btn-danger text-white border border-warning d-flex align-items-center g-3" title="View Logs" data-bs-toggle="tooltip" data-id="{{ $row->id }}">Logs</button>
