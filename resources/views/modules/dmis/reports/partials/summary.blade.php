<table id="generated-report" class="table table-bordered">
    ...
    <tbody>
        ...
        <tr class="align-middle {{ $districtIndex % 2 == 0 ? 'bg-light' : '' }}">
            ...
            <td class="text-center fw-medium"><a href="{{ route('admin.apps.dmis.reports.district-details', ['district' => $district->id, 'type' => $type ?? "Road"]) }}">{{ $district->damaged_infrastructure_count }}</a></td>
