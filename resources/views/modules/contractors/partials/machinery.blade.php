...
$(document).ready(function() {
    $('.editable').on('click', function() {
        ...
        input.on('blur', function() {
            ...
            $.ajax({
                url: `{{ route('module.contractors.machinery.update', ':machineId') }}`.replace(':machineId', machineId),
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    field: field,
    ...
    $('.file-input').each(function(key, value) {
        ...
        imageCropper({
            ...
            onComplete: async function(file, input) {
                ...
                const url = '{{ route("admin.contractors.machinery.upload", ":id") }}'.replace(':id', machineId);
    ...
    $(".table-machinery").on('click', '.delete-machine-btn', async function() {
            ...
            const url = `{{ route('module.contractors.machinery.destroy', ':machineId') }}`.replace(':machineId', machineId);
