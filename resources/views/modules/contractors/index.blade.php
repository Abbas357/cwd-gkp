    ...
    <script>
        $(document).ready(function() {
            var table = initDataTable('#contractors', {
                ajaxUrl: "{{ route('module.contractors.index') }}"
                , columns: [{
                        data: "id"
            ...
            hashTabsNavigator({
                table: table
                , dataTableUrl: "{{ route('module.contractors.index') }}"
                , tabToHashMap: {
                    "#active-tab": '#active'
            ...
            pushStateModal({
                fetchUrl: "{{ route('module.contractors.detail', ':id') }}"
            ...
            pushStateModal({
                fetchUrl: "{{ route('module.contractors.hr.detail', ':id') }}"
                , btnSelector: '.hr-btn'
            ...
            pushStateModal({
                fetchUrl: "{{ route('module.contractors.machinery.detail', ':id') }}"
            ...
            pushStateModal({
                fetchUrl: "{{ route('module.contractors.experience.detail', ':id') }}"
