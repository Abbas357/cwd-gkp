<x-service_card-layout title="Service Cards Settings">
    @push('style')
        <style>
    ...
    @endpush
    <x-slot name="header">
        <li class="breadcrumb-item"><a href="{{ route('admin.apps.service_cards.index') }}">Service Cards</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <form action="{{ route('admin.apps.service_cards.settings.init') }}" method="POST" onsubmit="return confirm('This will reset all settings to default values. Continue?');">
                            @csrf
            ...
            <div class="col-md-9">
                <form id="settingsForm" action="{{ route('admin.apps.service_cards.settings.update') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <input type="text0" id="appname" name="settings[appname][value]" value="{{ old('settings[appname][value]', setting('appName', 'service_card')) }}" class="form-control @error('appname') is-invalid @enderror"" placeholder="App Name" required>
