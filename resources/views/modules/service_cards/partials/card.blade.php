...
<div id="capture">
    <div class="service-card service-card_front text-center">
        ...
        <img src="{{ asset('admin/images/cards/service-card-front.png') }}?cw=77" alt="Service Card Front"
        ...
        <div class="footer">
            <div class="sign">
                <img src="{{ asset('admin/images/cards/service-card-sign.png') }}?cw=77" alt="Sign">
            </div>
    ...
    <div class="card service-card service-card_back">
        ...
        <img src="{{ asset('admin/images/cards/service-card-back.png') }}?cw=77" alt="Service Card Back"
            class="background-image">
