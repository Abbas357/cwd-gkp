                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Asset Functional Status...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Asset Color...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered category-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="new-item-row">
                                                            <td>
                                                                <input type="text" class="form-control new-item" placeholder="Add new Asset Registration Status...">
                                                            </td>
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success add-item">
                                                                    <i class="bi bi-plus-circle"></i>
