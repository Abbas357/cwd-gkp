<x-asset-layout title="Asset Dashboard">
    ...
    <x-slot name="header">
        <li class="breadcrumb-item active" aria-current="page">Asset Dashboard</li>
    </x-slot>
    ...
    <div class="wrapper">
            ...
            <div class="col-md-3">
                <div class="stat-card card h-100" style="background: #00ff0015; border: 1px solid #00ff0050;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted mb-2">Functional Assets</h6>
                                <h3 class="mb-0">{{ $functionalAssets }}</h3>
            ...
            <div class="col-md-3">
                <div class="stat-card card h-100" style="background: #ffd90015; border: 1px solid #ffd90050;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted mb-2">Alloted Assets</h6>
                                <h3 class="mb-0">{{ $allotedAssets }}</h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0">{{ $condemnedAssets }}</h3>
                            </div>
        ...
        <div class="row g-3">
            <div class="col-md-8">
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">Asset Types</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">Asset Colors</h5>
                            </div>
                            <div class="card-body">
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-primary" style="width: {{ $totalAssets > 0 ? ($personalAllotmentCount / $totalAssets) * 100 : 0 }}%"></div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-info" style="width: {{ $totalAssets > 0 ? ($officePoolCount / $totalAssets) * 100 : 0 }}%"></div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-success" style="width: {{ $totalAssets > 0 ? ($departmentPoolCount / $totalAssets) * 100 : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <h5 class="card-title mb-0">Assets Needing Attention</h5>
                    </div>
                    <div class="card-body">
                        @foreach($assetsNeedingAttention as $asset)
                        <div class="d-flex align-items-center mb-3">
                            <span class="alert-badge bg-warning"></span>
                            <div>
                                <h6 class="mb-1">{{ $asset->brand }} {{ $asset->model }}</h6>
                                <p class="mb-0 small text-muted">{{ $asset->functional_status }}</p>
                                @if($asset->allotment)
                                    @if($asset->allotment->user_id)
                                        <small class="text-muted">Alloted to: {{ $asset->allotment->user->name }}</small>
                                    @elseif($asset->allotment->office_id)
                                        <small class="text-muted">Alloted to: {{ $asset->allotment->office->name }}</small>
                                    @endif
                                @endif
                            </div>
                        </div>
