                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" action="{{ route('admin.apps.hr.permissions.store') }}" method="post" novalidate>
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col">
                                    ...
                                    <table class="table p-5 table-stripped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="delete-permission-form-{{ $permission->id }}" method="post" action="{{ route('admin.apps.hr.permissions.destroy', ['permission' => $permission->id]) }}" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
