                    ...
                    <div class="rounded-4 overflow-hidden">
                        <div class="admin-grid">
                            <div class="grid-container">
                                ...
                                <a href="{{ route('admin.standardizations.index') }}" class="grid-item text-decoration-none text-dark">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center p-3">
                                        <div class="app-icon">
                                ...
                                <a href="{{ route('admin.service_cards.index') }}" class="grid-item text-decoration-none text-dark">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center p-3">
                                        <div class="app-icon">
