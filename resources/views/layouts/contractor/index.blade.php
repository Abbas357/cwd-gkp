...
<body class="loading">
    ...
    @include("layouts.contractor.partials.header")
    @if ($showAside)
        @include("layouts.contractor.partials.aside")
    @endif
    ...
    @include("layouts.contractor.partials.footer")
    @include("layouts.contractor.partials.theme-switcher")
