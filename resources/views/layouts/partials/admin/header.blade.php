...
<head>
    ...
    <link href="{{ asset('admin/css/bootstrap-extended.css') }}?cw=56" rel="stylesheet">
    <link href="{{ asset('admin/css/dark-theme.css') }}?cw=56" rel="stylesheet">
    <link href="{{ asset('admin/css/main.min.css') }}?cw=56" rel="stylesheet">
    <link href="{{ asset('admin/css/semi-dark.css') }}?cw=56" rel="stylesheet">
    <link href="{{ asset('admin/css/bordered-theme.css') }}?cw=56" rel="stylesheet">
    <link href="{{ asset('admin/css/responsive.css') }}?cw=56" rel="stylesheet">
    <script>
    ...
    @stack('style')
    <link href="{{ asset('admin/css/custom.min.css') }}?cw=56" rel="stylesheet">
    <style>
        .page-loader {
            height: 5px;
            width: 250px;
