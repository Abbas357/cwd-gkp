...
<x-sidebar app-name="WEBSITE" app-url="{{ route('admin.home') }}">
    ...
    <li>
        ...
        <ul class="px-2 py-1 menu-items">
            ...
            <li><a href="{{ route('admin.gallery.index') }}"><i class="bi-images fs-6"></i>Gallery</a></li>
            @endcan
            @can('view any slider')
            <li><a href="{{ route('admin.sliders.index') }}"><i class="bi-card-image fs-6"></i>Sliders</a></li>
            @endcan
            @can('view any story')
    ...
    <li>
        <a class="has-arrow" href="javascript:;">
            <div class="parent-icon"><i class="bi-kanban"></i>
            </div>
            <div class="menu-title">Projects</div>
        </a>
        <ul class="px-2 py-1 menu-items">
            <li><a class="has-arrow" href="javascript:;"><i class="bi-globe fs-6"></i> Foreign Funded</a>
                <ul class="px-2 py-1 menu-items">
                    @can('view any project')
                    <li><a href="{{ route('admin.projects.index') }}"><i class="bi-kanban fs-6"></i> Projects</a></li>
                    @endcan
                    @can('view project file')
                    <li><a href="{{ route('admin.project_files.index') }}"><i class="bi-folder fs-6"></i>Files</a></li>
                    @endcan
                </ul>
            </li>
            @can('create development project')
            <li><a href="{{ route('admin.development_projects.index') }}"><i class="bi-buildings fs-6"></i>Developmental</a></li>
            @endcan
            @can('view any scheme')
    ...
    <li>
        <a href="javascript:;" class="has-arrow">
            <div class="parent-icon"><i class="bi-envelope text-danger"></i></div>
