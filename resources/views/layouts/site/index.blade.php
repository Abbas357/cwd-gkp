...
<head>
    ...
    <link href="{{ asset('site/css/style.min.css') }}?cw=30" rel="stylesheet">
    @stack('style')
    <link href="{{ asset('site/css/custom.min.css') }}?cw=30" rel="stylesheet">
    <script>
        (function() {
            const savedTheme = localStorage.getItem('selectedTheme');
            if (savedTheme && savedTheme !== 'default') {
                document.write(`<link id="theme-stylesheet" rel="stylesheet" href="{{ asset('site/css/themes/${savedTheme}.css') }}?cw=30">`);
            }
        })();
    </script>
</head>
...
<body>
    ...
    <script src="{{ asset('site/js/menu.min.js') }}?cw=30"></script>
    <script src="{{ asset('site/js/core.min.js') }}?cw=30"></script>
