...
<head>
    ...
    <meta property="og:logo" content="{{ asset('site/images/logo-square.png') }}?cw=60">
    ...
    <link href="{{ asset('site/css/bootstrap.min.css') }}?cw=60" rel="stylesheet">
    <link href="{{ asset('site/css/bootstrap-extended.css') }}?cw=60" rel="stylesheet">
    <link href="{{ asset('site/css/style.min.css') }}?cw=60" rel="stylesheet">
    @stack('style')
    <link href="{{ asset('site/css/custom.min.css') }}?cw=60" rel="stylesheet">
    <script>
        (function() {
            const savedTheme = localStorage.getItem('selectedTheme');
            if (savedTheme && savedTheme !== 'default') {
                document.write(`<link id="theme-stylesheet" rel="stylesheet" href="{{ asset('site/css/themes/${savedTheme}.css') }}?cw=60">`);
            }
...
<body>
    ...
    <script src="{{ asset('site/js/menu.min.js') }}?cw=60"></script>
    <script src="{{ asset('site/js/core.min.js') }}?cw=60"></script>
    <script src="{{ asset('site/js/utils.min.js') }}?cw=60"></script>
