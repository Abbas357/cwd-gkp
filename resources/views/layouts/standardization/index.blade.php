...
<body class="loading">
    ...
    @include("layouts.standardization.partials.header")
    @if ($showAside)
        @include("layouts.standardization.partials.aside")
    @endif
    ...
    @include("layouts.standardization.partials.footer")
    @include("layouts.standardization.partials.theme-switcher")
