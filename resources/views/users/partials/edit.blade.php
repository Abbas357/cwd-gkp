            ...
            <div id="roles" class="rand-grid">
                @foreach($data['allRoles'] as $role)
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $role->name }}" role="switch" id="role{{ $role->id }}"
                            @if($data['roles']->pluck('name')->contains($role->name)) checked @endif>
        ...
        <div class="tab-pane fade" id="permissions" role="tabpanel">
            ...
            <div id="permissions" class="rand-grid">
                @foreach($data['allPermissions'] as $permission)
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission->name }}" role="switch" id="permission{{ $permission->id }}"
                            @if($data['permissions']->pluck('name')->contains($permission->name)) checked @endif>
