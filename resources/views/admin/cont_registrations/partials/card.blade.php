...
<div id="capture">
    <div class="contractor-card contractor-card_front text-center">
        ...
        <div class="image">
            <img src="{{ $ContractorRegistration->getFirstMediaUrl('contractor_pictures') ?: asset('admin/images/no-profile.png') }}" alt="{{ $ContractorRegistration->contractor_name }}">
        </div>

        <div class="main">
            <h1>{{ $ContractorRegistration->contractor_name }}</h1>
            <h2> {{ $ContractorRegistration->applied_category }} / {{ $ContractorRegistration->pec_number }}</h2>
            <h3> Name: {{ $ContractorRegistration->owner_name }}</h3>
        </div>
            ...
            <div class="back-main">
                <div class="d-flex justify-content-start align-items-center pt-1 mb-1 border-bottom border-secondary">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>{{ $ContractorRegistration->cnic }}</div>
                    </div>
                ...
                <div class="d-flex justify-content-start align-items-center pt-1 mb-1 border-bottom border-secondary">
                    <div class="d-flex justify-content-around align-items-center">
                        ...
                        <div>{{ $ContractorRegistration->district }}</div>
                    </div>
                    <div class="d-flex justify-content-around align-items-center ml-auto">
                        <div class="fw-bold">Registration No: &emsp;</div>
                        <div>{{ $ContractorRegistration->reg_no }}</div>
                    </div>
                </div>
                <div class="d-flex justify-content-start align-items-center pt-1 mb-1 border-bottom border-secondary">
                    <div class="d-flex justify-content-around align-items-center">
                        <div class="fw-bold">Email: &emsp;</div>
                        <div style="overflow: hidden; text-overflow: ellipsis;">{{ $ContractorRegistration->email }}</div>
                    </div>
                </div>
                <div class="d-flex justify-content-start align-items-center pt-1 mb-1 border-bottom border-secondary">
                    <div class="d-flex justify-content-around align-items-center">
                        <div class="fw-bold">Mobile Number: &emsp;</div>
                        <div style="overflow: hidden; text-overflow: ellipsis;">{{ $ContractorRegistration->mobile_number }}</div>
                    </div>
                </div>
                
                <div class="d-flex justify-content-start align-items-center pt-1 mb-1 border-bottom border-secondary">
                    <div class="fw-bold">Address: &emsp;</div>
                    <div style="overflow: hidden; text-overflow: ellipsis;">{{ $ContractorRegistration->address }}</div>
                </div>
            </div>
