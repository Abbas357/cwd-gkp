                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" action="{{ route('admin.contractor_categories.store') }}" method="post" novalidate>
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col">
                                    ...
                                    <table class="table p-5 table-stripped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="delete-contractor_category-form-{{ $contractor_category->id }}" method="post" action="{{ route('admin.contractor_categories.destroy', ['contractor_category' => $contractor_category->id]) }}" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
