                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="needs-validation" action="{{ route('admin.roles.store') }}" method="post" novalidate>
                                                @csrf
                                                <div class="row mb-3">
                                                    <div class="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form id="delete-role-form-{{ $role->id }}" method="post" action="{{ route('admin.roles.destroy', ['role' => $role->id]) }}" style="display:inline;">
                                                                @csrf
                                                                @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            ...
            async function openModalFromUrl() {
                ...
                const url = "{{ route('admin.roles.getPermissions', ':id') }}".replace(':id', roleId);
                const updateURL = "{{ route('admin.roles.updatePermissions', ':id') }}".replace(':id', roleId);
