...
$(document).ready(function() {
    $('.editable').on('click', function() {
        ...
        input.on('blur', function() {
            ...
            $.ajax({
                url: `{{ route('admin.contractors.machinery.update', ':machineId') }}`.replace(':machineId', machineId),
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    field: field,
    ...
    $(".table-machinery").on('click', '.delete-machine-btn', async function() {
            ...
            const url = `{{ route('admin.contractors.machinery.destroy', ':machineId') }}`.replace(':machineId', machineId);
