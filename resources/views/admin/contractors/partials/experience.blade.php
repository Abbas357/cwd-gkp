...
$(document).ready(function() {
    $('.editable').on('click', function() {
        ...
        input.on('blur', function() {
            ...
            $.ajax({
                url: `{{ route('admin.contractors.experience.update', ':experienceId') }}`.replace(':experienceId', experienceId),
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    field: field,
    ...
    $(".table-experience").on('click', '.delete-experience-btn', async function() {
        ...
        const url = `{{ route('admin.contractors.experience.destroy', ':experienceId') }}`.replace(':experienceId', experienceId);
