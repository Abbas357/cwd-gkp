...
class ContractorCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('admin.categories.contractor_categories.index', compact('contractor_categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('admin.contractor_categories.index')->with('success', 'Contractor Category Created successfully.');
    }
