...
class CardController extends Controller
{
        ...
        if ($request->ajax()) {
            $dataTable = Datatables::of($cards)
                ...
                ->editColumn('status', function ($row) {
                    return view('admin.cards.partials.status', compact('row'))->render();
                })
                ->addColumn('view', function ($row) {
                    return view('admin.cards.partials.view', compact('row'))->render();
                })
    ...
    public function view($id)
    {
        ...
        $html = view('admin.cards.partials.cards', compact('card', 'qrCodeUri'))->render();
