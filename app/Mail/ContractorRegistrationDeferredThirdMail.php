...
class ContractorRegistrationDeferredThirdMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Contractor Registration Deferred - Final Notification',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.registration.third-deferment',
            with: [
