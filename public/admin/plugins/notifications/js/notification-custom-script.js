...
function img_default_noti() {
	Lobibox.notify('default', {
		...
		continueDelayOnInactiveTab: false,
		position: 'top right',
		img: 'assets/plugins/notifications/images/1.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_info_noti() {
	Lobibox.notify('info', {
		...
		icon: 'bi bi-info-circle',
		position: 'top right',
		img: 'assets/plugins/notifications/images/2.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_warning_noti() {
	Lobibox.notify('warning', {
		...
		continueDelayOnInactiveTab: false,
		position: 'top right',
		img: 'assets/plugins/notifications/images/3.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_error_noti() {
	Lobibox.notify('error', {
		...
		icon: 'bi bi-x-circle',
		position: 'top right',
		img: 'assets/plugins/notifications/images/4.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_success_noti() {
	Lobibox.notify('success', {
		...
		position: 'top right',
		icon: 'bi bi-check2-circle',
		img: 'assets/plugins/notifications/images/5.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
/* Notifications With Images*/
